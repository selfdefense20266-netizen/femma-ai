...
exports.FOOD_RECIPES = exports.FOOD_MEALS = exports.CATEGORY_WEEKS = exports.ANIMATION_STEPS = exports.WEEKDAYS = exports.ROADMAP_WEEKS = exports.ROADMAP_ENVIRONMENTS = exports.ROADMAP_TIMES = exports.ROADMAP_CATEGORIES = void 0;
exports.ROADMAP_CATEGORIES = [
    'weight_loss',
    'tone',
    'muscle',
    'boxing',
...
exports.ROADMAP_TIMES = ['15 min', '20–30 min', '30–45 min', '45–60 min', '60+ min'];
exports.ROADMAP_ENVIRONMENTS = ['home', 'gym', 'both'];
exports.ROADMAP_WEEKS = [4, 8, 12];
...
function move(title, animation, cue) {
    return {
        title,
        animation,
        cue,
        steps: exports.ANIMATION_STEPS[animation] || exports.ANIMATION_STEPS.flow,
    };
}
function week(home, gym) {
...
function pack(id, label, planName, missionCategory, href, courseId, courseIds, courseTopics, block) {
    return {
        id,
        label,
        planName,
...
exports.CATEGORY_WEEKS = {
    boxing: pack('boxing', 'Boxing', 'Boxing Power Plan', 'safety', '/library/self-defence/sd-boxing', 'sd-boxing', ['sd-boxing'], ['stance and jab', 'cross and guard', 'footwork', 'hooks', 'round timing', 'bag combos', 'technical reset'], BOXING),
    mma: pack('mma', 'MMA', 'MMA Fighter Plan', 'safety', '/library/self-defence/sd-mma', 'sd-mma', ['sd-mma', 'sd-boxing'], ['stance and sprawl', 'kick chambers', 'clinch posture', 'level changes', 'defense', 'mixed flow', 'recovery skill'], MMA),
    karate: pack('karate', 'Karate', 'Karate Plan', 'safety', '/library/self-defence/sd-karate', 'sd-karate', ['sd-karate'], ['reverse punch', 'front kick', 'kata lines', 'roundhouse', 'stepping punch', 'forms', 'precision'], KARATE),
    selfdefense: pack('selfdefense', 'Self-Defense', 'Self-Defense Plan', 'safety', '/library/self-defence/sd-foundations', 'sd-foundations', ['sd-foundations', 'sd-boxing'], ['stance and voice', 'releases', 'elbows', 'get-ups', 'block and counter', 'awareness', 'scenario'], SELFDEFENSE),
    weight_loss: pack('weight_loss', 'Weight Loss', 'Weight Loss Plan', 'fitness', '/library/fitness/fit-weight-loss', 'fit-weight-loss', ['fit-weight-loss', 'fit-hiit', 'fit-cardio'], ['easy burn', 'lower-body engine', 'core and walk', 'intervals', 'full-body move', 'weekend burn', 'active recovery'], WEIGHT_LOSS),
    tone: pack('tone', 'Tone & Sculpt', 'Tone & Sculpt Plan', 'fitness', '/library/fitness/fit-core', 'fit-core', ['fit-core', 'fit-strength', 'fit-pilates'], ['glute sculpt', 'leg lines', 'upper-body tone', 'core control', 'inner-thigh', 'full sculpt', 'recovery tone'], TONE),
    muscle: pack('muscle', 'Build Muscle', 'Strength Plan', 'fitness', '/library/fitness/fit-strength', 'fit-strength', ['fit-strength', 'fit-core'], ['squat pattern', 'push strength', 'hinge', 'pause work', 'lunges', 'posterior chain', 'accessories'], MUSCLE),
    hiit: pack('hiit', 'HIIT', 'HIIT Burn Plan', 'fitness', '/library/fitness/fit-hiit', 'fit-hiit', ['fit-hiit', 'fit-cardio'], ['squat intervals', 'lunge bursts', 'burpee engine', 'core finishers', 'lateral power', 'tabata', 'flush day'], HIIT),
    yoga: pack('yoga', 'Yoga', 'Yoga Flow Plan', 'yoga', '/library/fitness/fit-yoga', 'fit-yoga', ['fit-yoga'], ['sun salutations', 'balance', 'twists', 'core flow', 'hips', 'restorative', 'savasana'], YOGA),
    flexibility: pack('flexibility', 'Flexibility', 'Flexibility Plan', 'yoga', '/library/fitness/fit-mobility', 'fit-mobility', ['fit-yoga', 'fit-mobility'], ['hamstrings', 'hips', 'quads', 'full-body open', 'shoulders', 'deep squat', 'passive hold'], FLEXIBILITY),
    stress: pack('stress', 'Stress Relief', 'Calm Body Plan', 'yoga', '/library/fitness/fit-yoga', 'fit-yoga', ['fit-yoga', 'fit-mobility'], ['box breathing', 'walk and breathe', 'restore', 'easy mobility', 'grounding', 'nidra', 'sunday reset'], STRESS),
    confidence: pack('confidence', 'Confidence', 'Confidence Plan', 'safety', '/library/self-defence/sd-foundations', 'sd-foundations', ['sd-foundations', 'sd-boxing', 'fit-foundations'], ['power stance', 'strong stands', 'palm strike', 'posture', 'combo presence', 'fight stance', 'take up space'], CONFIDENCE),
    pregnancy: pack('pregnancy', 'Pregnancy Wellness', 'Pregnancy Wellness Plan', 'yoga', '/library/cycle-pregnancy/cph-pregnancy', 'cph-pregnancy', ['cph-pregnancy', 'fit-yoga'], ['supported squat', 'side-lying strength', 'cat-cow', 'easy walk', 'posture', 'modified flow', 'calm breath'], PREGNANCY),
    postpartum: pack('postpartum', 'Postpartum Recovery', 'Postpartum Recovery Plan', 'yoga', '/library/cycle-pregnancy/cph-postpartum', 'cph-postpartum', ['cph-postpartum', 'cph-recovery-wellness'], ['core reconnect', 'sit to stand', 'easy walk', 'gentle hip', 'posture rows', 'march and breathe', 'recovery'], POSTPARTUM),
};
exports.FOOD_MEALS = {
    'Eat everything': [
        'Scan your lunch',
